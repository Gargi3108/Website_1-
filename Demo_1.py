...
#with st.container():
#    st.subheader("Bangle")
#    st.image("artifacts\images\Bangle.webp")
#    st.subheader("Ring")
#    st.image("artifacts\images\Ring.webp")
#    st.subheader("Earring")
#    st.image("artifacts\images\Earring.webp")

col1, col2, col3 = st.columns([2, 2, 2],gap="medium",vertical_alignment='center',border=True)
col1.subheader("Bangle")
col1.image("artifacts/images/Bangle.webp")
col2.subheader("Ring")
col2.image("artifacts/images/Ring.webp")
col3.subheader("Earring")
col3.image("artifacts/images/Earring.webp")  
